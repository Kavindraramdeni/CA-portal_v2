...
export const tasksApi = {
  ...
  bulkApprove: (ids: string[]) =>
    api.post('/tasks/bulk-approve', { ids }).then((r) => r.data),
...
export const teamsApi = {
  ...
  addMember: (teamId: string, userId: string) =>
    api
      .post(`/teams/${teamId}/members`, { user_id: userId })
      .then((r) => r.data),
...
export const timesheetsApi = {
  ...
  getWeekly: () =>
    api.get('/timesheets/weekly').then((r) => r.data),
...
export const billingApi = {
  ...
  getOutstanding: () =>
    api.get('/billing/outstanding').then((r) => r.data),
...
export const analyticsApi = {
  ...
  getStaffUtil: () =>
    api.get('/analytics/staff-utilisation').then((r) => r.data),
};
...
export const complianceApi = {
  ...
  getSchedules: () =>
    api.get('/compliance/schedules').then((r) => r.data),

  createSchedule: (data: any) =>
    api.post('/compliance/schedules', data).then((r) => r.data),
};
